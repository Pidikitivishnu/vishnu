...
public class MovingStock extends Testbase{
	...
	public MovingStock(WebDriver driver)throws Throwable
	{
		PageFactory.initElements(driver,this);
	}


	public Stockmoving wareHousetoshowRoom() throws Throwable {
		...
		Add.click();
		savebtn.click();
		return  new Stockmoving();
		
	}
	public Stockmoving showRoomtowareHouse() throws Throwable
	{
