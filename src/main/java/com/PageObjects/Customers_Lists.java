...
public class Customers_Lists extends Testbase{
	 public Customers_Lists() throws Throwable {
		super();
	...
	@FindBy(xpath="//input[contains(@class,'form-control-sm')]")
	    ...
	    public Customers_Lists(WebDriver driver)throws Throwable
	    {
	    	PageFactory.initElements(driver,this);
	    }
	    public  Customers_Lists editcustomer() throws Throwable
	    {
			...
			return new Customers_Lists();
	    }
	    public  Customers_Lists deletecustomer() throws Throwable
	    {
