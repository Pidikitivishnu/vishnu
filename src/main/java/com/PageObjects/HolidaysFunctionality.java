...
public class HolidaysFunctionality extends Testbase
{ 
	public HolidaysFunctionality() throws Throwable {
		super();	 
	}
//adddnew
...
public HolidaysFunctionality(WebDriver driver)throws Throwable
...
public void deleteholiday()
{
 ...
 {
	 int size1=rows.size();
	 Assert.assertEquals( HolidaysFunctionality.size-1,size1);
