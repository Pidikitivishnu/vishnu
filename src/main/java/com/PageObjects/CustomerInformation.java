...
public class CustomerInformation extends Testbase{
	...
	public CustomerInformation() throws Throwable {
		super();
    ...
    WebElement save;
    public CustomerInformation(WebDriver driver) throws Throwable
    {
    	PageFactory.initElements(driver,this);
    }
    public Customers_Lists addcustomer() throws Throwable
    {
